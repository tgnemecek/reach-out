...
public class CompanionAlocator : MonoBehaviour
{
    ...
    private StudioEventEmitter connectSound;
    ...
    private static int companionCount = 0;
    ...
    public void OnCollisionEnter(Collision collision)
    {
        if(collision.gameObject.tag == "Unit")
        {
            ...
            if (!ai.IsCompanion())
            {
				...
				connectSound.GetComponent<FMODUnity.StudioEventEmitter>().Play();
                ...
                OneLiners.Instance.GenerateLiner("Join");
                connectSound.Play();
    ...
    public static void RemoveCompanion(int index)
    {
        ...
        OneLiners.Instance.GenerateLiner("Fled");
